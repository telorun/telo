...
- 51d7156: `Ai.Tools` entry `result:` accepts a content part or a list of parts, not just a string.
...
- 8cede51: Add the image-generation contract types and the provider-neutral usage quantity.

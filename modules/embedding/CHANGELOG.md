...
### Added
* Update controller @telorun/embedding to 0.4.0.## 0.5.0 - 2026-07-19
### Added
...
### Added
* Update controller @telorun/embedding to 0.3.0.## 0.3.0 - 2026-07-12
### Added
* Describe exported resource kinds via metadata.description for semantic discovery.## 0.2.0 - 2026-06-20
### Added
* Update controller @telorun/embedding to 0.2.0.## 0.1.0

...
export function AppLifecyclePanel({ onOpen, onStartFromTemplate, recentRootDir }: AppLifecyclePanelProps) {
  return (
    <div className="flex h-full flex-1 flex-col items-center justify-center gap-4 bg-zinc-50 px-6 text-center dark:bg-zinc-900">
      <div className="flex flex-col items-center gap-1">
        ...
        <p className="max-w-sm text-xs text-zinc-500 dark:text-zinc-500">
          Start from a working template, or open a directory to load its modules. An empty
          directory becomes a new workspace — you can add applications and libraries from the
          sidebar.
        </p>
      </div>

...
### Fixed
* Update controller @telorun/lease to 0.4.1.## 0.6.1 - 2026-07-27
### Fixed
...
### Added
* Describe exported resource kinds via metadata.description for semantic discovery.## 0.3.0 - 2026-07-09
### Added
* Update controller @telorun/lease to 0.3.0.## 0.2.0 - 2026-07-06
### Added
* Update controller @telorun/lease to 0.2.0.## 0.1.0

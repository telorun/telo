...
The Tesseract model for Japanese, vertical text (Japanese script), as one ready-made model a recognizer
...
imports:
  ...
  JpnVert: oci://ghcr.io/telorun/tesseract-lang/jpn_vert
---
kind: Tesseract.Recognizer
metadata:
  name: recognizer
languages:
  - !ref JpnVert.jpn_vert
  - !ref Tesseract.eng
```

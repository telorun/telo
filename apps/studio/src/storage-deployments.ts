...
// folded into `telo-studio:ui-state:v2` (the UI-focus `PersistedState`). Keeping
// them separate lets each evolve independently — a schema bump here shouldn't
// force a migration of rootDir/activeView, and vice versa.
const KEY = LOCAL_KEYS.deployments;

...
The Tesseract model for Azerbaijani (Cyrillic script), as one ready-made model a recognizer
...
imports:
  ...
  AzeCyrl: oci://ghcr.io/telorun/tesseract-lang/aze_cyrl
---
kind: Tesseract.Recognizer
metadata:
  name: recognizer
languages:
  - !ref AzeCyrl.aze_cyrl
  - !ref Tesseract.eng
```

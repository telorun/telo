 ...
 *  Replaces a tagged scalar (`!cel`, `!interpolate`, `!sql`) at load time.
 ...
 *  text fragments plus the separately-evaluated value of each `${{ }}` hole, with `fragments.length === values.length + 1`. A consumer emits

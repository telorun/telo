...
"@telorun/codec": minor
"@telorun/plain-text-codec": minor
"@telorun/ndjson-codec": minor
"@telorun/sse-codec": minor
"@telorun/octet-codec": minor
"@telorun/http-server": major
...
Streaming-Invocable convention, format-codec packages, and `Http.Api` `content:` map rewrite.

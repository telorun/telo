...
The Tesseract model for Chinese (Traditional), vertical text (Han script), as one ready-made model a recognizer
...
imports:
  ...
  ChiTraVert: oci://ghcr.io/telorun/tesseract-lang/chi_tra_vert
---
kind: Tesseract.Recognizer
metadata:
  name: recognizer
languages:
  - !ref ChiTraVert.chi_tra_vert
  - !ref Tesseract.eng
```

# Tesseract chi_sim_vert

The Tesseract model for Chinese (Simplified), vertical text (Han script), as one ready-made model a recognizer
...
imports:
  ...
  ChiSimVert: oci://ghcr.io/telorun/tesseract-lang/chi_sim_vert
---
kind: Tesseract.Recognizer
metadata:
  name: recognizer
languages:
  - !ref ChiSimVert.chi_sim_vert
  - !ref Tesseract.eng
```
